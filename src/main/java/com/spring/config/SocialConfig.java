...
import com.spring.social.ConnectionSignUpImpl;
...
public class SocialConfig implements SocialConfigurer {
    ...
    // @env: read from com.spring.social-cfg.properties file.
    @Override
    ...
    public UsersConnectionRepository getUsersConnectionRepository(ConnectionFactoryLocator connectionFactoryLocator) {
        ...
        // org.springframework.com.spring.social.security.SocialAuthenticationServiceRegistry
        ...
        if (autoSignUp) {
            // After logging in to com.spring.social networking.
